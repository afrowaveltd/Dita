...
public class Storage
{
   ...
   /// </summary>
   /// <remarks>Use this property to specify the storage backend for the application. The default value is
   /// StorageType.AjisFiles. Changing this property may affect how and where data is stored and retrieved.</remarks>
   public StorageType StorageType { get; set; } = StorageType.AjisFiles;
   /// <summary>
   /// Gets or sets the storage location used for persisting data.
   /// </summary>
   /// <remarks>Use this property to specify where data should be stored. The default value is <see
   /// cref="StorageLocation.InFolderStorage"/>. Changing this property may affect data accessibility and persistence
   /// behavior depending on the selected storage location.</remarks>
