...
เอกสารนี้อธิบายสถาปัตยกรรมของระบบแปลแบบอัตโนมัติของดิตะ ถูกนํามาใช้เพื่อปรับปรุงความทนทาน ความทนทาน และการยืดหยุ่น.

## ออกแบบเป้าหมาย

ความ กังวล หลาย อย่าง เกี่ยว กับ การ ออก แบบ แบบ แบบ หิน ใหญ่ แบบ ดั้งเดิม:
...
- ตรวจหาแฟ้มต้นฉบับที่มีการเปลี่ยนแปลงโดยใช้ hash-256 hadhes
...
- การตรวจสอบความถูกต้องของโครงสร้าง เพื่อให้แน่ใจว่ามีการนับหัว, รายชื่อ, บล็อกโค้ด เป็นต้น
...
- ประมวลผลด้วยท่อส่งแก๊สแบบเต็ม (local) Libre Translate
- สัญญาณตรวจสอบ ส่งข้อความไปยังไคลเอนต์ที่เชื่อมต่ออยู่
...
- ตรวจสอบแฟ้มภาษาเป้าหมายทั้งหมด ถูกสร้าง/ update
