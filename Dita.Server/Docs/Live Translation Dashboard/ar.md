...
جميع الإشارات وتُعرض الأحداث التي تُجرى من خط الترجمة التحريرية في جدول مستكمل:
...
- ** الملاذية Hb** () - SignalR hub that broadcasts messages to all connected clients
...
2. الملاحة إلى
3. إجراء عملية ترجمة (إما الانتظار إلى الجدول الزمني أو الاتصال بآلية التكيف)
4. مشاهدة الأحداث تظهر في الوقت الحقيقي
5. استخدام زر التصدير لالتقاط أثر كامل للتدمير

## التحسينات المقبلة

التحسينات المعتزم إدخالها على لوحة المتابعة:
...
- ** الإحصاءات** - المواد التي تبين حسابات الترجمة التحريرية، ومعدلات الخطأ، والتساهل مع الزمن
- ** محفزات مانية** - بوتون لبدء مراحل خط أنابيب محددة يدويا
- ** المحكمــة** - محررة مباشرة من لوحة المتابعة
- ** إدارة اللغات** - الرؤية والتحرير اللغات المدعومة
- ** استعراض أولي تمهيدي** - قواميس الحشد والبحث

## الاضطرابات

### لوحة الداشون تُظهر "مُحار للتواصل"

1. التحقق من الخادم يجري ويسهل الوصول إليه
2. كشغّل مصفّح لشركات CORS أو أخطاء الشبكات
3. يوجد تأكيد
4. ضمان عدم قيام أي جدار ناري بعرقلة الاتصالات عبر الشبكة
...
4. الشيك جدول شبكي للرسائل الشبكية

### الرسائل خارج النظام

الحقل يضمن أن يُطلب خلال عملية واحدة إذا ظهرت الرسائل خارج النظام، يمكن أن تشير إلى ما يلي:
