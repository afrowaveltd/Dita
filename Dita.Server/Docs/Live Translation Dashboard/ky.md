...
Бардык сигналдар Котормо түтүктөрүнүн R иш-чаралары жандуу жаңыртуу таблицасында көрсөтүлгөн:
...
4. Браузерди текшериңиз WebSocket билдирүүлөрү үчүн тармактык таблица
