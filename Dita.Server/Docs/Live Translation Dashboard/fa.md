...
- **LocalizationHub ** () – سیگنالR Hub که پیام ها را به تمام مشتریان متصل می کند
...
### داشبورد نشان می دهد "شکست برای اتصال"
...
- چندین خط لوله همپوشانی دارد (با توجه به قفل semaphore اتفاق نمی افتد)
