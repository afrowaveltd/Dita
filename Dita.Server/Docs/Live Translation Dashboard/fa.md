...
همه سیگنال ها رویدادهای R از خط لوله ترجمه در یک جدول زنده نمایش داده می شود:
...
- استفاده از کتابخانه مشتری Microsoft SignalR JavaScript (loaded from CDN)
...
5. از دکمه صادرات برای گرفتن یک ردیابی کامل برای اشکال زدایی استفاده کنید
