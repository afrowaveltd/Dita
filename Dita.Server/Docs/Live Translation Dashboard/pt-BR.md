...
Todos os eventos SignalR do oleoduto de tradução são exibidos em uma tabela de atualização ao vivo:
...
- **LocalizationHub** () — SignalR hub que transmite mensagens para todos os clientes conectados
...
1. Começa o Dita. Aplicação do servidor
2. Navegar para
