...
เอกสารนี้ใช้เป็นตัวทดสอบแบบสดสําหรับส่งค่าไปทดสอบสําหรับท่อแปลภาษาอัตโนมัติ การเปลี่ยนแปลงใด ๆ ของแฟ้มนี้ จะทําการแทนที่แฟ้มภาษาเป้าหมายอีกครั้ง ในครั้งต่อไป.

## ภาพรวมของสถาปัตยกรรม

ท่อส่งคําแปลได้ถูกดัดแปลงเป็นสถาปัตยกรรมสหกรณ์ ที่มีบริการย่อยพิเศษ 4 คน ประสานงานกันโดยวงออร์เคสตราเบา:
...
บริการดําเนินการตามตารางเวลาและดําเนินการทางท่อส่งเอกสารห้าระยะ: การตรวจสอบความถูกต้องเซิร์ฟเวอร์, การปรับเทียบข้อมูลประเทศ, การปรับเทียบข้อมูลพจนานุกรม Json, การแปลแฟ้มมาร์กดาวน์, และยังคงผล แต่ละเวทีปล่อยโครงสร้าง ความคืบหน้าจริงเหนือสัญญาณ เพื่อให้ลูกค้าที่เชื่อมต่อกันได้ ทํางานต่อไปได้.
...
- หากการแปลล้มเหลว บริการจะปรับปรุงใหม่ถึง 3 ครั้งด้วยระยะเวลา 30 วินาที ก่อนที่จะย้ายไปเป็นภาษาถัดไป.

### ขั้น ที่ 3 — แปล เจ สัน

บริการจะเปรียบเทียบพจนานุกรมระบบปริยายปัจจุบันกับภาพที่เก็บไว้จากการทํางานครั้งก่อน:
...
- การ แปล ด้วย มือ ย่อม สําคัญ เป็น อันดับ แรก เสมอ. หาก พจนานุกรม เป้า หมาย มี ค่า สําหรับ คีย์ อยู่ แล้ว รายการ นั้น จะ ไม่ เปลี่ยน แปลง ไม่ ว่า แหล่ง ที่ มา นั้น จะ บอก อย่าง ไร.
...
3. กัญชา ที่ เก็บ ไว้ จาก การ วิ่ง ครั้ง ก่อน (ถูก เก็บ ไว้ ใน แฟ้ม ที่ อยู่ ถัด ไป จาก แฟ้มซอร์ส, หรือ ใน ตําแหน่ง ที่ พลาด อยู่ ชั่ว คราว) ถูก นํา มา เทียบ กับ แฮช ปัจจุบัน.
...
8. หากแฟ้มเป้าหมายทั้งหมดสําหรับแหล่งที่ประสบความสําเร็จ กัญชาใหม่จะถูกเก็บไว้ถัดจากแหล่ง หากการเขียนต่อไปยังแหล่งต้นทางล้มเหลว (ตัวอย่างเช่นในการใช้สิทธิ์ในการอ่านอย่างเดียว) แฮชจะย้อนกลับไปยังไดเรกทอรีชั่วคราว.
...
- นับจากแฟ้มท้องถิ่นที่บันทึกคือ Json, บันทึกแฟ้มมาร์กดาวน์, บันทึกข้อมูลแฮช, และลงบันทึก.
...
ถ้า ระยะ ใด ๆ ที่ ไม่ ได้ รับ การ กําหนด ระยะ ที่ เหลือ ก็ จะ มี การ ส่ง ข้อ ความ และ ใน ที่ สุด ก็ มี การ ปิด ข้อความ.
...
- การปกปิดตําแหน่ง: ผู้ ถือ ตําแหน่ง ที่ มี ชื่อ ตาม ข้อ ความ นั้น ถูก แทน ที่ ชั่ว คราว ด้วย สัญลักษณ์ ที่ ปลอด ภัย () ก่อน จะ แปล และ หลัง จาก นั้น ก็ ได้ รับ การ ฟื้นฟู ให้ แน่ ใจ ว่า ไวยากรณ์ ถูก ต้อง ใน ภาษา ของ เป้า หมาย.
