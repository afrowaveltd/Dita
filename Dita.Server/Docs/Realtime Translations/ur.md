...
یہ سروس ایک شیڈول پر چلتی ہے اور ایک پانچ آنے والی پائپ لائن کا اجرا کرتی ہے: سرور منظوریشن، ملک شمسی نظام، جے ڈیکلو ڈکشنری سنینچرونیشن، مارک ڈاؤنر فائل اور نتائج کو جاری رکھتی ہے۔ ہر مرحلے میں سائنل آر پر حقیقی وقتی ترقی کے واقعات خارج ہوتے ہیں تاکہ کام کی آمدنی کے طور پر وابستہ گاہکوں کی پیروی کی جا سکے۔.
...
ملک کے نام کو صرف کیٹلاگ () سے مقامی طور پر جامد میں محفوظ کیا جاتا ہے۔.
...
اس سروس میں حالیہ ڈیٹنگ مقامی ڈکشنری کو سابقہ رن سے محفوظ کردہ ایک سابقہ رن سے تشبیہ دی گئی ہے:
...
- دستی ترجمے ہمیشہ ترجیح دیتے ہیں۔ اگر کسی ہدف کی لغت میں پہلے ہی سے ایک اہم چیز پائی جاتی ہے توپھرپھر ماخذ کی بات سے قطع‌نظر اس میں داخل ہونا باقی ہے ۔.
...
تمام خلیات کو ہمیشہ حروف تہجی کے ساتھ ترتیب دیا جاتا ہے اور انسانی پڑھنے کی صلاحیت کے لیے بے ترتیب جِلد کر دیا جاتا ہے۔.
...
7. ترجمہ شدہ فائلوں کو کامیابی کے ساتھ ترتیب دیا جاتا ہے جس سے ماخذ (دونوں فہرستیں، فہرستیں، کوڈ بلاکس، بلاک بلاکس، لنکس، بہادر/ٹیریل مارکرز، اور ایچ ٹی ایم ایل ٹیگس کے لیے درج کیے جاتے ہیں۔.
...
9. اگر کوئی بھی ہدف ترجمہ درستی میں ناکام ہو جاتا ہے تو میٹاداٹا ان بلاکس کی نشان دہی کرتا ہے تاکہ وہ اگلے مرحلے پر دوبارہ حملہ کر سکیں ۔.
...
- محفوظ شدہ فائلوں کی تعداد، مارک ڈاؤن فائل محفوظ کی گئی، محفوظ کردہ فائلیں، بچ گئیں، اور گریٹنگ حاشیہ لکھتا ہے۔.
- دوڑ کے دوران کوئی بھی ذخیرہ شدہ غلطیاں جمع ہوتی ہیں۔.
...
### سٹیج-سطح ری ایکٹر (Translation Reseration Resport)
...
- ترجمہ سے پہلے اور بعد میں دوبارہ سے درست گرائمر کو نشانہ زبانوں میں شامل کرنے سے پہلے متن میں اس کی جگہ جگہ جگہ : اسم‌نویسوں ( نام ) کو عارضی طور پر استعمال کِیا جاتا ہے ۔.

### زبان درست

- کسی ہدف کی زبان کا ترجمہ کرنے سے پہلے سروس زبان کو ترجمان سرور کی حمایت حاصل ہے۔.
...
غلطیوں کی اطلاع دی جاتی ہے کہ متحدہ انیم گروپ کو قطروں میں استعمال کرتے ہوئے:
...
- کھانا صاف کرنے اور تمام پیغامات جون کو برآمد کرنے میں مدد دیتا ہے۔.
