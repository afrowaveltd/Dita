...
এই ডকুমেন্টটি ডিটা স্বয়ংক্রিয় অনুবাদ সার্ভিসের সব পরিবর্তনকে সংক্ষেপে তুলে ধরেছে, যার মধ্যে স্থাপত্যের নতুন নতুন, নতুন বৈশিষ্ট্য, উন্নতি এবং স্থানীয় উন্নতিও রয়েছে ।.
...
- **KasalR প্রকাশকারী** - রিয়েল টাইম রিপোর্ট দ্বারা প্রতিবেদন
...
- সকল সংকেত প্রদর্শন করা হবে ইভেন্টে রত
...
স্থানীয়ভাবেকরণ ব্যবস্থা বর্তমানে places (উন্নয়নের) বিভিন্ন ভাষায় বর্হিভূত গ্লুকোজের জন্য ব্যবহার করা হচ্ছে:
...
- সুনির্দিষ্ট অবস্থানের সাথে সুসংগত হলেও, বিপরীত দিশায় নির্ধারিত স্থান পরিবর্তন করুন
...
ক্লাস ক্লায়েন্ট সংযোগের জন্য RHMA'র সাথে সংযোগ স্থাপন করা হয়েছে।.
...
- এই বিষয়ে নতুন পরীক্ষার সংবাদ:
  - অবস্থান: পরিসেবা সংক্রান্ত বৈশিষ্ট্য
  - ব্যাক- এন্ড সার্ভিসের চার্জ
...
- — আপডেট করা পাইপ-লাইন ডকুমেন্টেশন
- নির্দেশনা খুঁজুন
...
- ক্লাস একই বিন্যাস ব্যবহার করা হবে
...
2. নতুন ইন্টারফেস ব্যবহারের উদ্দেশ্যে DI নিবন্ধনের তথ্য আপডেট করা হয়েছে
