...
เอกสาร ฉบับ นี้ สรุป การ เปลี่ยน แปลง ทุก อย่าง ที่ เกิด ขึ้น กับ การ แปล แบบ อัตโนมัติ ของ ดิตา รวม ทั้ง การ ปรับ ปรุง สถาปัตยกรรม, ลักษณะ ใหม่, การ ปรับ ปรุง แก้ไข ความ สามารถ ใน การ ใช้ งาน, และ การ ปรับ ปรุง ระบบ ท้อง ถิ่น.
...
- แสดงสัญญาณทั้งหมด R เหตุการณ์ที่เกิดขึ้น
...
สัญญาณ R Hot is planced for context ของลูกค้า.
...
- เพิ่มข้อมูลการทดสอบใหม่
  - ที่อยู่ คุณสมบัติของบริการ
  - การแทนที่โปรแกรมเบื้องหลัง วง ออร์ เคส ตรา
...
- — ฉบับ แปล มาระ โก
- -สัญญาณ กําลังพิมพ์ข้อความ
- -พยายามตรรกะด้วยการปกปิดตําแหน่ง
- — ผู้ จัด พิมพ์
...
การเปลี่ยนแปลงทั้งหมดถูกเติมเข้าไป:

- การใช้รหัสท้องถิ่น () ทํางานได้ไม่เปลี่ยนแปลง
...
- ** เพิ่มข้อมูล ** วิ่ง: มีการเปลี่ยนแปลง/ เสียหายจากการเปลี่ยนชื่อบล็อกใหม่
