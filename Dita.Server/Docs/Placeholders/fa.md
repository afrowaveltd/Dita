...
### 1. مقدار زمان (برای داده های پویا)
...
### 2. ارزش های ذخیره شده (برای پیکربندی نیمه استاتیک)
...
3. ** پس از ترجمه **: نام های مالک اصلی () در موقعیت های صحیح خود بازسازی می شوند.
...
به طور خودکار حفظ مکان دارنده در طول تماس های LibreTranslate را کنترل می کند. هیچ پیکربندی اضافی لازم نیست.
