...
ويتمتع أصحاب المسكنات المسماة بمصدرين للقيم:
...
عندما تلتقي دائرة الترجمة الآلية بالنص مع أصحاب الأماكن المسمّين:

1. ** قبل الترجمة**: ويُخفى الملاجئ بعلامات آمنة () لمنع محرك الترجمة من تعديلها.
2. ** ترجمة**: محرك الترجمة يعمل فقط النص القابل للترجمة.
3. ** بعد الترجمة**: استعيدت أسماء أصحاب الأماكن الأصلية في مناصبهم الصحيحة.
...
1. ** استخدام الأسماء الوصفية**: أفضل من أو
2. ** حافظوا على المسكنات عند الحد الأدنى**: الكثير من المسكنات يجعلون الترجمة أكثر صعوبة
3. ** الأنواع المتوقعة من الوثائق**: تساعد التعليقات الواردة في ملف " جون " المترجمين على فهم السياق
...
لا تزال المدونة القائمة التي تستخدم حاملي أماكن العمل أو لا يوجد أصحاب أماكن تعمل دون تغيير:
