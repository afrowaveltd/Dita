...
Локализацияланган жипти алуу учурунда маанилерди түздөн-түз өткөрүп берүү:
...
5. ** Демейкилер үчүн сакталган маанилерди колдонуу**: Конфигурацияны сейрек өзгөртүү үчүн (тиркеме аталышы, электрондук почта колдоо)
