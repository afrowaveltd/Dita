...
Dita локалдаштыруу саптарында ** аталган орун ээлерин ** колдойт, динамикалык маанилерди иштөө учурунда киргизүүгө мүмкүндүк берет, ошол эле учурда тилдердин ортосунда туура грамматиканы сактайт.

## Синтаксис

Жайгашкан жер ээлери JSON сөздүгүнүн маанилеринин ичинде ийри-буйру жип синтаксисин колдонушат:
...
3. ** Котормодон кийин**: Оригиналдуу жер ээсинин аталыштары () алардын туура позицияларында калыбына келтирилет.
...
4. ** Жүргүзүлгөн иштөө убактысынын маанилери**: Чыныгы динамикалык маалыматтар (колдонуучунун аты-жөнү, саны, даталары) үчүн, иштөө убактысында маанилерди өткөрүү
...
LibreTranslate чалуулары учурунда орун ээлеринин сакталышын автоматтык түрдө жүргүзөт. Кошумча конфигурация талап кылынбайт.

"Эки сөз тең ""ретри"" кызматын колдонушат, ошондуктан JSON сөздүктөрүнүн бардык котормолору белгилүү бир орун ээлерин ачык колдойт.".
