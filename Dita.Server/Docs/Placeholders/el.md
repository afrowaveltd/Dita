...
Η Dita υποστηρίζει ** με το όνομα placeholders** σε συμβολοσειρές εντοπισμού, επιτρέποντας την εισαγωγή δυναμικών τιμών στο χρόνο εκτέλεσης, ενώ παράλληλα διατηρεί τη σωστή γραμματική σε όλες τις γλώσσες.

## Σύνταξη

Οι τοπικοί κάτοχοι χρησιμοποιούν τη σύνταξη σγουρά brace μέσα σε τιμές λεξικού JSON:
...
Σε αντίθεση με τους κατόχους θέσεων (, ), οι ονομαζόμενοι τοπικοί κάτοχοι είναι ** γλώσσα-αγνωστικιστές** - μεταφραστές μπορούν να τους αναδιατάξει για να ταιριάζει γραμματική της γλώσσας-στόχου χωρίς να σπάσει τον κώδικα.
...
3. ** Μετά τη μετάφραση **: Τα αρχικά ονόματα τοποθέτων () αποκαθίστανται στις σωστές τους θέσεις.
...
- Η γραμματική της γλώσσας-στόχου μπορεί να αναδιοργανώσει ελεύθερα το περιβάλλον κείμενο
...
3. ** Αναμενόμενοι τύποι εγγράφων **: Σχόλια στο αρχείο JSON βοηθούν μεταφραστές κατανοήσουν το πλαίσιο
