# Назовани участници в локализацията
...
За разлика от positional placeholders (, ), назовани placeholders са **language-agnostic **  готварски преводачи могат да ги пренареди да отговарят на целева език граматика, без да се нарушава кода.
...
Запаметените стойности действат като ** по подразбиране ** и са надхвърлени от стойностите на времето за изпълнение.
...
1. ** Преди превод **: Държачите са маскирани със сейфове (), за да се предотврати промяната им в транслационния двигател.
...
Това гарантира, че:
- Собствениците никога не се превеждат или развалят
...
3. **Документ очаквани видове **: Коментарите във файла JSON помагат на преводачите да разберат контекста
4. ** Предпочитам стойности за времето на движение **: За наистина динамични данни (имена на потребителите, бройки, дати), преминете стойности в работно време
...
Съществуващ код, като се използват позиционни притежатели или няма притежатели на места, които продължават да работят без промяна:
...
Нареченият притежател на име API е допълнение към него не нарушава съществуващото използване.
