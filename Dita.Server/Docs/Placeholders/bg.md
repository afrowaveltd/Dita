...
За разлика от позиционните placeholders (, ), назоваваните placeholders са **език-агностик **  год. преводачите могат да ги пренареждат да отговарят на целта език граматика, без да се нарушава кода.

## Съхранение

Имената на собствениците имат два източника на стойности:

### 1. Времеви стойности (препоръчвани за динамични данни)
...
### 2. Запаметени стойности (за полустатична конфигурация)
...
1. ** Преди превод **: Държачите са маскирани със сейфове (), за да се предотврати промяната на преводаческия двигател.
2. **During translation**: The translation engine processes only the translatable text.
3. **След превод**: Оригиналните имена на притежателя () се възстановяват в техните правилни позиции.
...
Това гарантира, че:
- Собствениците никога не биват превеждани или корумпирани
...
3. **Документ очаквани видове **: Коментари в JSON файл помогне на преводачите да разберат контекста
