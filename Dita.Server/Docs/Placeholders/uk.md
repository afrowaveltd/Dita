...
1. **Переклад**: Власники розміщуються на безпечних токених () для запобігання їх модифікації.
2. **During translation**: Процеси перекладу тільки перекладеного тексту.
3. **Після перекладу**: Оригінальні імена власників () реставруються в своїх правильному положенні.
