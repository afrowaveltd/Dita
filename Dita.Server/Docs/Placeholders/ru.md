...
Dita поддерживает **named placeholders** в строках локализации, позволяя вставлять динамические значения во время выполнения, сохраняя правильную грамматику на разных языках.
...
### 1. Значения времени выполнения (рекомендуемые для динамических данных)
...
3. **Документы ожидаемых типов**: Комментарии в файле JSON помогают переводчикам понять контекст
