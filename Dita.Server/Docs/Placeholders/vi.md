...
3. **Document mong đợi kiểu**: Comment
...
Cả hai đều sử dụng dịch vụ thử lại, do đó, tất cả các từ điển JSON dịch thuật một cách trong suốt hỗ trợ tên của người giữ chỗ.
