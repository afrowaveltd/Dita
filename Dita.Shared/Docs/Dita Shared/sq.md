...
Paketa:
|---|---|---|
Tërhiqu. Instrumentë të përbashkët. Api
Tërhiqu. Instrumentë të përbashkët. Modeli
postkit
pikëdig
Microsoft. AspNetCore. Sinjali. Core
Microsoft. Shtesë. Karrocë. Abstraksione
Microsoft. Shtesë. Duke pritur. Abstraksione
Microsoft. Shtesë. Vendodhja. Abstraksione
Njutonoft

## Struktura e directory
...
|---|---|---|
Autentifikimi
Tubacioni i plotë i përkthimit, lokalizuesi JSON, shpërndarësi i sinjaleve, përkthimi i shënuar, vendshënuesit, mesoret
Modeli i konfigurimit SMTP
