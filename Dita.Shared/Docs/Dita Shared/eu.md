...
## Proiektuaren metadatuak

Propietatea
|---|---|
Helburuko markoa
ezeztagarria
Inplikazioak erabiltzea
Dokumentazio-fitxategia

### NuGet mendekotasunak

Paketea
|---|---|---|
Afrowave. Tresna partekatuak. Api
Afrowave. Tresna partekatuak. Modeloak
MailKit
Markdig
Microsoft. AspNetCore. Seinalea. Corey
Microsoft. Hedapenak. Caching. Abstrakzioak
Microsoft. Hedapenak. Ostatua. Abstrakzioak
Microsoft. Hedapenak. Lokalizazioa. Abstrakzioak
Newtonsoft.Json
...
## Azpisistemaren ikuspegi orokorra
...
- **Interface-first**: zerbitzu bakoitzak fokua duen interfazea du (, , e.a.)
- **Erresult objektuak salbuespenen gainetik**: zerbitzu-metodo guztiek erroreen kudeaketa segurua itzultzen dute
- **Haren segurtasuna**: in, , in ; in
- **Erresistentzia handia**: hiztegiak eta Markdown fitxategiak hizkuntza bakoitzeko gordetzen dira itzulpenaren ondoren berehala
- **Degradazio harrigarria**: falta diren fitxategiek bilduma hutsak sortzen dituzte, ez salbuespenak
- **Idatz ezazu miss**-n, eta gehitu automatikoki falta diren gakoak hiztegi lehenetsian, itzulpen atzeratua egiteko
