...
Пакети
|---|---|---|
Афрохвильова піч. Поділитися Апі
Афрохвильова піч. Поділитися Моделі
Кошик
Маркіг
Майкрософт. AspNet Зареєструватися Головна
Майкрософт. Розширення. Кешування. Анотація
Майкрософт. Розширення. Партнерство Анотація
Майкрософт. Розширення. Локалізація. Анотація
Ньютонсофт.Джсон
...
Підсистема
|---|---|---|
Ауттентифікаційні результати кодів
**Локалізація**
Модель конфігурації SMTP (заплановані послуги)

## Принципи проектування

- **Interface-first**: every service has a focused interface (`ILanguageService`, `IPlaceholderService`, `ISignalRPublisher`, etc.)
- **Результати об'єктів за винятком**: всі способи обслуговування повертаються для безпечного обробки помилок
...
- **Порожня деградація**: відсутні файли виробляють порожні колекції, не винятки
- **Write- Провідний пропуск**: і автоматично відсутні ключі до словника за замовчуванням для відкладного перекладу
