...
Afrowave. SharedTools. Modely
MailKit
Markdig
Microsoft. AspNetCore. SignalR. hlavní
Microsoft. Rozšíření. Caching. Abstrakce
Microsoft. Rozšíření. Hosting. Abstrakce
Microsoft. Rozšíření. Lokalizace. Abstrakce
Newtonsoft. Json
...
Subsystém
|---|---|---|
Kódy výsledků ověření
Plný překlad potrubí, JSON localizer, SignalR hub, markdown translation, middleware
SMTP konfigurační model (plánované služby)
