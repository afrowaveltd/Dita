...
|---|---|---|
| Afrowave.SharedTools.Api | 0.0.3 | `ICookieService`, `Response<T>` |
| Afrowave.SharedTools.Models | 1.4.0-alpha | `Language`, `Response<T>` result type |
| MailKit | 4.16.0 | SMTP email sending |
| Markdig | 1.1.3 | Markdown AST parsing |
| Microsoft.AspNetCore.SignalR.Core | 1.2.9 | Real-time hub infrastructure |
| Microsoft.Extensions.Caching.Abstractions | 10.0.5 | `IDistributedCache` |
| Microsoft.Extensions.Hosting.Abstractions | 10.0.7 | `IHostedService`, `IHostEnvironment` |
| Microsoft.Extensions.Localization.Abstractions | 10.0.5 | `IStringLocalizer`, `IStringLocalizerFactory` |
| Newtonsoft.Json | 13.0.4 | Legacy JSON serialisation |
...
|---|---|---|
| **Identity** | `Dita.Shared.Identity.Enums` | Authentication result codes |
| **Localization** | `Dita.Shared.Localization.*` | Full translation pipeline, JSON localizer, SignalR hub, markdown translation, placeholders, middleware |
| **Mailer** | `Dita.Shared.Mailer.Models` | SMTP configuration model (services planned) |
