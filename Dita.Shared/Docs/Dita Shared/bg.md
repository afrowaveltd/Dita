...
Опаковка
|---|---|---|
Афромах. Споделени инструменти. Api
Афромах. Споделени инструменти. Модели
MailKit
Маркдиг
Майкрософт. AspNetCore. Сигнализатор. Основна
Майкрософт. Разширения. Кешинг. Абстракции
Майкрософт. Разширения. Домакин. Абстракции
Майкрософт. Разширения. Локализиране. Абстракции
Нютънсофт
...
- **Interface-first **: всяка услуга има фокусиран интерфейс (, , , и т.н.)
- **Result objects over exceptions**: all service methods return `Response<T>` for safe error handling
- ** Thread safety **: in , ,
- **Устойчивост **: речници и файлове Markdown се съхраняват на език веднага след превод
- ** Graceful defaction **: Липсващите файлове произвеждат празни колекции, а не изключения
- **Пишете чрез на госпожица **: и автоматично-прибавяне липсващи ключове към речника по подразбиране за отложен превод
