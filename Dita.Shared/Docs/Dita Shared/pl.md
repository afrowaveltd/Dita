...
Opakowanie
|---|---|---|
Furofala. SharedTools. Api
Furofala. SharedTools. Modele
MailKit
Markdig
Microsoft. AspNetCore. Sygnał. Bazowa
Microsoft. Wydłużenia. Caching. Abstrakcje
Microsoft. Wydłużenia. Hosting. Abstrakcje
Microsoft. Wydłużenia. Lokalizacja. Abstrakcje
Newtonsoft.Json
...
Podsystem
|---|---|---|
Kody wyniku uwierzytelniania
Pełny rurociąg tłumaczeniowy, lokalizator JSON, węzeł SignalR, tłumaczenie markdown, uchwyty, middleware
Model konfiguracji SMTP (planowane usługi)
