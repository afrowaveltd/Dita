...
Paquete
|---|---|---|
Afrowave. ferramentas compartidas. Api
Afrowave. ferramentas compartidas. Modelos
MailKit
Markdig
Microsoft. AspNetCore. sinal. núcleo
Microsoft. Extensións. Caching. Abstractas
Microsoft. Extensións. Hosting. Abstractas
Microsoft. Extensións. Localización. Abstractas
Newtonsoft.Json
...
Oleoduto completo de tradución, localizador JSON, hub SignalR, tradución de marca, localizadores, middleware
Modelo de configuración SMTP (servizos previstos)
...
- **Write-through on miss**: e as chaves que faltan para a tradución diferida
